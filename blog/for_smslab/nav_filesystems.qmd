...
description: "Quick guide for navigating Sapelo2 filesystems"
...
::: {.callout-warning}
The `/scratch/` filesystem is intended for temporary files and active computational work. Files that have not been accessed or modified for more than 30 days, as per GACRC guidelines, may be automatically deleted. Do not treat `/scratch/` as permanent storage.
