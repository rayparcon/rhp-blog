---
title: "How to Run STRUCTURE on HPC Using Structure_threader and Visualize Results Using R"
description: "Step-by-step guide for running STRUCTURE population genomics analyses on an HPC cluster using structure_threader, PGDSpider, and R."
...
```bash
scp snps.str USERNAME@:/scratch/USERNAME/structure/
```
...
```bash
scp -r USERNAME@:/scratch/USERNAME/structure/snps_results_25pop_10rep .
```
